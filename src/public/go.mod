module gitlab.com/golibs-starter/golib-sample-public
...
require (
	...
	gitlab.com/golibs-starter/golib-security v0.8.8-beta
	gitlab.com/golibs-starter/golib-test v0.2.5-beta
