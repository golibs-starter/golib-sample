...
require (
	...
	gitlab.com/golibs-starter/golib-data v0.7.0
	gitlab.com/golibs-starter/golib-gin v0.5.0
	gitlab.com/golibs-starter/golib-message-bus v0.1.3
	gitlab.com/golibs-starter/golib-migrate v0.0.1
	...
	gitlab.com/golibs-starter/golib-security v0.8.4
	gitlab.com/golibs-starter/golib-test v0.2.2
